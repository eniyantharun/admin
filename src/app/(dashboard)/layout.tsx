...
const DashboardBackground = memo(() => (
  <div className="dashboard-layout-background absolute inset-0 pointer-events-none">
    ...
    <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-radial from-blue-400/5 via-transparent to-transparent rounded-full"></div>
    <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-radial from-indigo-400/5 via-transparent to-transparent rounded-full"></div>
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-radial from-purple-400/3 via-transparent to-transparent rounded-full"></div>
  </div>
));
...
const FloatingElements = memo(() => (
  <div className="dashboard-layout-floating-elements pointer-events-none">
    ...
    <div className="absolute bottom-32 left-32 w-24 h-24 bg-gradient-to-br from-purple-400/10 to-pink-400/10 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
    <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-cyan-400/10 to-blue-400/10 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
  </div>
));
