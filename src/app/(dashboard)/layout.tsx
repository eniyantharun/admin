...
const FloatingElements = memo(() => (
  <div className="dashboard-layout-floating-elements pointer-events-none">
    ...
    <div
      className="absolute bottom-32 left-32 w-24 h-24 bg-gradient-to-br from-purple-400/10 to-pink-400/10 rounded-full animate-pulse"
      style={{ animationDelay: "1s" }}
    ></div>
    <div
      className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-cyan-400/10 to-blue-400/10 rounded-full animate-pulse"
